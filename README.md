...
The base code was provided with GNU AFFERO GENERAL PUBLIC LICENSE Version 3, 19 November 2007, there fore it is published with same LICENSE type. The several files in the original code were modified to support SVO2 files, to include ZED SDK, OPEN3D processing, and modified viewer, video and CSV outputs. Also, the newer YOLO models used and RT_DETR from Ultralytics.
